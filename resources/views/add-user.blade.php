                    ...
                    <div class="col-lg-6 col-12 m-auto text-right">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">نموذج اضافه مستخدم جديد</h4>
                            </div>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <select onchange="changeRole()" id="basic-form-6" name="type" class="form-control">
                                                        ...
                                                        <option @if(old('type') == 1) selected @endif value="1">ادمن</option>
                                                        <option @if(old('type') == 2) selected @endif value="2">موظف</option>
                                                        <option @if(old('type') == 3) selected @endif value="3">عامل مكتب</option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>

                                        <div class="form-row" id="floorId" style="@if(old('type') != 3) display: none @endif">
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <label for="basic-form-10">الطابق(الدور)*</label>
                                                        <select id="basic-form-10" name="floor" class="form-control">
                                                            ...
                                                            <option @if(old('floor') == 31) selected @endif value="31">31</option>
                                                            <option @if(old('floor') == 32) selected @endif value="32">32</option>
                                                            <option @if(old('floor') == 33) selected @endif value="33">33</option>
                                                        </select>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-12 col-12">
                                                <div class="form-group mb-2">
                                                    ...
                                                    <input type="number" max="1000" min="0" value="{{old('number_of_drinks')}}" id="basic-form-7" class="form-control" name="number_of_drinks">
                                                </div>
                                            </div>
                                        </div>
